                ...
                datatable = $('#kt_datatable').DataTable({
                    ...
                    columns: [
                        {data: 'id', title: 'ID'},
                        {
                            ...
                            render: function (data, type, row) {
                                if( row.username+"" !="null"){
                                    var temp = "<a href=\"#\" class=\"load-modal\" rel=\"{{route('admin.view-profile',['username'=>""])}}" + row.username + "\">" + row.username + "</a>";
                                    return temp;
                                }
                                else{
                                    return "";
                        ...
                        },
                        {
                            ...
                            render: function (data, type, row) {
                                if( row.email+"" !="null"){
                                    var temp = "<a href=\"#\" class=\"load-modal\" rel=\"{{route('admin.view-profile',['username'=>""])}}" + row.username + "\">" + row.email + "</a>";
                                    return temp;
                                }
                                else{
                                    return "";
                        ...
                        {
                            data: "roles", title: '{{__('Nhóm quyền')}}', orderable: false,
                            render: function (data, type, row) {
                                var temp = "";
                                $.each(row.roles, function (index, value) {
                                    if (value.name == 'admin') {
                                        temp += "<span class=\"btn btn-block btn-danger btn-xs\">" + value.title + "</span><br />";
                                    } else {
                                        temp += "<span class=\"btn btn-block btn-primary btn-xs\">" + value.title + "</span><br />";
                                    }
                                });
                                return temp;
                            }
