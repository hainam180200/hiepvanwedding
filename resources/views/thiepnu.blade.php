...
<title>Kính gửi Phạm Thị Hà Trang ! - Thiệp mời đám cưới online</title>
<meta name="description" content="Trân trọng kính mời Phạm Thị Hà Trang đến tham dự buổi tiệc chung vui cùng gia đình chúng tôi!" />
...
<meta property="og:title" content="Kính gửi Phạm Thị Hà Trang ! - Thiệp mời đám cưới online" />
<meta property="og:url" content="https://truongtrangwd.iwedding.info/invitation/65211648169dd077c2078c32" />
<meta property="og:description" content="Trân trọng kính mời Phạm Thị Hà Trang đến tham dự buổi tiệc chung vui cùng gia đình chúng tôi!" />
...
<link rel="stylesheet" href="https://truongtrangwd.iwedding.info/invitation/style.css?v=20230909">
...
<div class="footer">
	<div class="container">
		<div class="invitation-button">
			...
			<a class="a-bii-small-logo" href="https://biihappy.com/wedding"><img class="bii-small-logo" src="https://truongtrangwd.iwedding.info/common/imgs/bii.png" /></a>
			<a class="btn btn-dark" href="https://truongtrangwd.iwedding.info" target="_blank">Xem website</a>
		</div>
	</div>
</div>
	...
	<div class="modal-content">
		...
		<div class="modal-body">
			 <form id="updateGuestForm" method="post">
				<div class="row">
					<input type="hidden" id="guest_id" name="guest_id" value="65211648169dd077c2078c32" >
					<div class="col-sm-6 col-12" style="margin-bottom: 10px;">
						<select class="form-select" name="attendance_status" id="attendance-status_id" style="margin-top: 4px;">
					...
					<div class="col-sm-6 col-12" style="margin-bottom: 10px;">
						<select class="form-select" name="plus_ones" id="plus-ones_id" style="margin-top: 4px;">
				...
				<div class="action-btns">
					...
					<button type="button" class="btn btn-dark btn-dark-1 donate">Mừng cưới</button>
...
<script type="text/javascript">
	const invitationInfo = {
		...
		'groom_name_one': 'T',
		'bride_name_one': 'T',
		'guest_name': 'Phạm Thị Hà Trang',
		'event_name': 'LỄ CƯỚI NHÀ NỮ',
		'event_time': '18:00 AM',
		'event_date': 'Thứ 7, NGÀY 21/10/2023',
		'event_date_dot': '21.10.2023',
		'event_address': 'Thôn Già Thượng, Xã Việt Tiến, Huyện Bảo Yên, Tỉnh Lào Cai',
	};
	const biicore = {webroot : 'https://truongtrangwd.iwedding.info', coreSite: 'https://biihappy.com', webToken: '65203311c4a03f7aa5055074'};
</script>
<script type="text/javascript" src="https://truongtrangwd.iwedding.info/invitation/script.js?v=20230909"></script>
<script type="text/javascript" src="https://truongtrangwd.iwedding.info/invitation/templates/h4/static.js?v=202302113"></script>
</body>
</html>